...
>在文末有code-past的定义：
```
[code-past]:/img/codepast-logo.jpg "公众号：新华网"
```
## 链接
### 链接外部URL
...
|#|语法|效果|
|---|----|-----|
|1|`[我的个人网站](http://yxkruc.top "悬停显示")`|[我的个人网站](http://yxkruc.top "悬停显示")|
...
但是这个网页每次都打开**奇慢**。所以原作者整理到了本repo中，大家可以直接在此查看[emoji](./emoji.md)。
